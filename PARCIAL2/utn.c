...
*
*/
int utn_isValidTexto(char *pBuffer, int limite)
{
    int retorno = 0;
    int i;
    if(pBuffer != NULL && limite > 0 && strlen(pBuffer) > 0)
...
*
*/
int utn_isValidFecha(int dia, int mes, int anio)
{
    int retorno = 0;
...
*
*/
int utn_isValidCuilOrCuit(char *pBuffer, int limite)
{
    int retorno = 0;
    int i;
                    ...
                    char *mensajeError, int reintentos)
{
        ...
        mensajeError != NULL && reintentos>=0)
    {
        do
        {
            ...
            printf("\n%s", mensaje);
            if( getString(buffer, limite) == 0 &&
                utn_isValidTexto(buffer, limite))
            {
                    ...
                    char *mensajeError, int reintentos)
{
        ...
        mensajeError != NULL && reintentos>=0)
    {
        do
        {
            ...
            if (utn_isValidFecha(dia, mes, anio))
            {
                        ...
                        char *mensajeError, int reintentos)
{
            ...
            mensajeError != NULL && reintentos>=0)
    {
        do
        {
            ...
            printf("\n%s", mensaje);
            if( getString(buffer, limite) == 0 &&
                utn_isValidCuilOrCuit(buffer, limite))
            {
